        ...
        return Commands.run(
                () -> {
                    ...
                    double scale = Math.pow(
                            MathUtil.applyDeadband(radius, Swerve.Constants.moveDeadband), Swerve.Constants.movePow);
                    ...
                    // Apply the deadband to the absolute value of rotation and take it to the power of turnPow for
                    // smoother control
