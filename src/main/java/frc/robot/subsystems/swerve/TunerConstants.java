...
// DON'T USE THIS ON THE BOT, THIS IS JUST FOR SIMULATION TESTING
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.1).withKI(0.0).withKD(0.0).withKS(0.048).withKV(0.124);
      ...
      new TalonFXConfiguration()
          .withCurrentLimits(
              new CurrentLimitsConfigs()
                  // WARNING: Using your specified current limit of 40A - verify this is appropriate
  ...
  public static final CANBus kCANBus = new CANBus("rhino", "./logs/example.hoot");
  ...
  // WARNING: Coupling ratio not specified in JSON - using template default
  // This MUST be calculated for your specific robot configuration
  ...
  // WARNING: Your JSON doesn't specify left/right inversion - using template defaults
  private static final boolean kInvertLeftSide = false;
  private static final boolean kInvertRightSide = true;

  // WARNING: Gyro ID 0 conflicts with potential motor IDs - consider changing
  ...
  private static final Voltage kSteerFrictionVoltage = Volts.of(0.4);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.303466796875);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.017578125);
  ...
  public static final SwerveModuleConstants<
      ...
      FrontLeft =
          ConstantCreator.createModuleConstants(
              ...
              kFrontLeftXPos,
              kFrontLeftYPos,
              kInvertLeftSide, // Drive motor inversion from JSON
  ...
  public static final SwerveModuleConstants<
      ...
      FrontRight =
          ConstantCreator.createModuleConstants(
              ...
              kFrontRightXPos,
              kFrontRightYPos,
              kInvertRightSide, // Drive motor inversion from JSON
