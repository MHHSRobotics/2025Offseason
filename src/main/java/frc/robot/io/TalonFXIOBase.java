...
public class TalonFXIOBase extends TalonFXIO{
    ...
    public void updateInputs(){
        ...
        updateSimulation();
        StatusCode sc=BaseStatusSignal.refreshAll(position,velocity,appliedVoltage,supplyVoltage,supplyCurrent,statorCurrent,temp,closedLoopReference,controlMode);
