    ...
    private void initSubsystems(){
        switch(Constants.currentMode){
            ...
            case SIM:
                ...
                LinearSystemSim<N2,N1,N2> mechSim=new SingleJointedArmSim(DCMotor.getKrakenX60(1), 
                    gearRatio,
                     Arm.moi, 
                     0, 
                     Arm.minAngle, 
                ...
                arm=new Arm(new TalonFXIOSim(Arm.motorId,mechSim,gearRatio),new CANcoderIOSim(Arm.encoderId,mechSim,gearRatio));
                break;
            default:
